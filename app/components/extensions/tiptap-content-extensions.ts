/**
 * [extensions/tiptap-content-extensions.ts] 문서 콘텐츠 보조 확장
 * 제목, 표 너비 보정, 글자 크기, 첨부파일, 수식 확장을 관리합니다.
 */
 ...
 * @param suggestionState.active - 팝업 활성 여부
 * @param suggestionState.items - 표시할 첨부파일 후보 목록
 * @param suggestionState.rect - 팝업 기준 위치
 * @param suggestionState.selectedIndex - 키보드 선택 인덱스
 * @param suggestionState.command - 후보 선택 시 실행할 삽입 함수
 */
