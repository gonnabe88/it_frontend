...
================================================================================
정보화사업 + 전산업무비 예산 현황을 3개의 카드로 요약 표시합니다.

[카드 구성]
  ① 전체 예산 합계: 정보화사업 + 전산업무비 합산 (인디고 그라디언트)
        ...
        <div
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <span class="ml-auto text-xs text-zinc-400">{{ projects.length + costs.length }}건</span>
                </div>
                <div class="text-3xl font-extrabold text-zinc-900 dark:text-zinc-50 tracking-tight">
                    {{ fmt(totalProjectBudget + totalCostBudget) }}
                    <span class="text-sm font-normal text-zinc-500">{{ selectedUnit }}</span>
                </div>
            </div>
            <!-- 내부 세부: 정보화사업 / 전산업무비 -->
            <div
                class="relative z-10 mt-4 pt-4 border-t border-indigo-100 dark:border-zinc-700 grid grid-cols-2 gap-4">
                <div class="flex items-center gap-2.5">
                    <div class="w-1.5 h-8 rounded-full bg-indigo-500"></div>
                    <div>
                        <div class="text-[11px] text-zinc-400 font-medium mb-0.5">정보화사업</div>
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <div class="text-[11px] text-zinc-400 font-medium mb-0.5">전산업무비</div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-zinc-100">
