        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl border border-zinc-200 p-5 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-xs font-medium text-zinc-500">결재 대기</div>
            ...
            <div class="bg-white rounded-xl border border-zinc-200 p-5 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-xs font-medium text-zinc-500">결재 진행 중</div>
                    <Skeleton v-if="pending" width="4rem" height="1.75rem" class="mt-1" />
                    <div v-else class="text-2xl font-bold text-blue-600 mt-0.5">
            ...
            <div class="bg-white rounded-xl border border-zinc-200 p-5 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-xs font-medium text-zinc-500">당월 완료</div>
                    <Skeleton v-if="pending" width="4rem" height="1.75rem" class="mt-1" />
                    <div v-else class="text-2xl font-bold text-green-600 mt-0.5">
                        {{ data?.monthlyCompletedCount ?? 0 }}
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-zinc-200 p-5 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-xs font-medium text-zinc-500">반려</div>
                    <Skeleton v-if="pending" width="4rem" height="1.75rem" class="mt-1" />
